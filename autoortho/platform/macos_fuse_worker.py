...
from autoortho.xplane.fuse import AutoOrtho, fuse_option_profiles_by_os
from autoortho.ui.stats import update_process_memory_stat, clear_process_memory_stat
...
try:
    from autoortho.core.crash_handler import install_crash_handler
...
def main():
    ...
    try:
        ...
        try:
            from autoortho.imagery.tiles import stats_batcher, shutdown
            if stats_batcher:
                stats_batcher.stop()
            shutdown()
        except Exception as e:
